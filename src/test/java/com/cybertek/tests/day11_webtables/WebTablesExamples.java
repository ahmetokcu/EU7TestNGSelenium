...
public class WebTablesExamples {
    ...
    public void printTableSize(){
        ...
        //number of rows
        List<WebElement> allRowsHeader = driver.findElements(By.xpath("//table[@id='table1']//tr"));
        System.out.println(allRowsHeader.size());
    ...
    public void getRow(){
        ...
        for (int i = 1; i <= numRows.size(); i++) {
            ...
            //***loop and for loop shortcuts iter and itar
    ...
    public void printallCellsByIndex(){
        ...
        for (int i = 1; i <= rowNumber; i++) {
            ...
            //iterate through each col on the table
